...
for row in cursor:
    print("BOOKID=",row[0])
    print("TITLEIDnew=",row[1],"old=",X)
    print("LOCATON=",row[2])
    print("GENRE=",row[3],"\n")


cursor=conn.execute("TITLEID,TITLE,ISBN,PUBLISHERID,PUBLICATIONYEAR from TITLES1")
for row in cursor:
    print("TITLEID=",row[0])
    print("TITLE=",row[1])
    print("ISBN=",row[2])
...
cursor=conn.execute("PUBLISHERID,NAME,STREETADDRESS,SUITENUMBER,ZIPCODEID from PUBLISHERS")
for row in cursor:
...
for row in cursor:
    ...
    print("CITY=",row[1],"old=",X)
    print("STATE=",row[2])
    print("ZIPCODE=",row[3],"\n")

cursor=conn.execute("AUTHORTITLEID,AUTHORID,TITLEID from AUTHORSTITLES")
for row in cursor:
